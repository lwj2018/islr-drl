...
class CSL_Isolated_Openpose_fixed(data.Dataset):
    ...
    def __init__(self, setname, skeleton_root=skeleton_root, 
        ...
        self.is_add_two_end = is_add_two_end
...
if __name__ == '__main__':
    # Path settings
    dataset = CSL_Isolated_Openpose_fixed('trainvaltest')
